...
We centered the data at the onset of the last syllable of the target items, and calculated estimations and probabilities of target fixations 200 ms later to account for the time it takes to plan and launch a saccade (e.g., Fischer, 1992; Saslow, 1967). 
...
The effect on the linear term indicates higher proficiency in the preterit tense was associated with earlier anticipation, but not in the present tense, where proficiency made no difference. 
...
The effect on the quadratic term indicates ________.
