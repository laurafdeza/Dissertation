...
<!-- I think you need a preposition or something before including, e.g., "by including" --> 
...
<!-- If the time course is centered at 200ms after the onset of the last syllable of the target word why do you have the 200ms vertical line? Also how is it possible for the ES group to be predicting at this point? --> 
...
<!-- This sentence reads funny. You mean you used only one bin at three different time points, right? It sounds like you still analyzed the time course but I don't think that is what you mean. --> 
...
<!-- 'as a fixed effect', this model didn't include time terms for the GCA? --> 
For the L2 speakers, we ran two GCA and two GLMM at each time stamp of interest.
<!-- I don't follow this. How can you run a GCA at one time stamp? And I dont know what a time stamp is... the time course? --> 
...
<!-- "to z-scores" is redundant". Also you are missing a "d" in "standardized" --> 
By-subject and by-item random effects were tested in all models. 
<!-- What about the time terms? Weren't their varying slopes? --> 
...
<!-- Nitpicky, but the L1s don't fixate on anything. --> 
...
<!-- The figure includes ES, EN and MA -->
...
<!-- You can report this as a probability too to help your reader interpret it `plogis(X)` --> 
...
<!-- I think you want the preposition "on" here. --> 
...
<!-- Over the time course? At a specific point? --> 
...
<!-- Can you explain this a bit more and justify why there are two models? --> 
...
<!-- does it? Which of the 4 terms? Can you be more specific here? --> 
...
<!-- Ok, I definitely don't follow here. How does the absence of a main effect imply they were anticipating? Don't you just mean that there wasn't a difference in the log odds of focusing on the target based on tense and stress? You need to walk the reader through this. --> 
...
<!-- Again, explain how. What is this specific parameter estimate? --> 
...
<!-- These probabilities come from the predict function from the GCA, right? They way you are reporting this it sounds as if you are saying the parameter estimates of the GCA tell you this. --> 
...
<!-- Same comments as above. I don't believe it is this straightforward. You will need to explain a bit more. --> 
...
<!-- same comments as above. You need to explain how. --> 
...
<!-- Are these nested model comparisons? THey just seem like different models. How are they nested? --> 
...
<!-- Explain how you know this from the model. --> 
