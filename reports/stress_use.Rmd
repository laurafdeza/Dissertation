...
<!-- Cris: I would explain why you used each analysis --> 
...
<!-- Cris: I would add the levels for each categorical variable --> 
...
<!-- Cris: You haven't answered the previous comment, which effects were random intercept and which random slope, check this http://www.bristol.ac.uk/media-library/sites/cmm/migrated/images/10s.gif--> 
...
<!-- Cris: three L1 populations sounds very confusing. All groups? --> 
...
<!-- Cris: you haven't added the previous comment --> 
