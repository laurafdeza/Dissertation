...
if(F){
  ...
  # mod_ot3a   32 100714 100963 -50325   100650   4.6444  7    0.70327    
          ...
          mod_ot4 <- update(mod_ot2, . ~ . + (1 + DELE_z + use_z + l1_sum | target))
          ...
          mod_ot7 <- update(mod_ot6, . ~ . -(1 + DELE_z + use_z + l1_sum + ot1 + ot2 | target) +
                               + ot3 + (1 + DELE_z + use_z + l1_sum + ot1 + ot2 + ot3 | target)) 
                    # Warning message:
          ...
          #          npar    AIC    BIC  logLik deviance   Chisq Df Pr(>Chisq)    
          # mod_ot2    10 100873 100951 -50426   100853                          
          # mod_ot4   20 100709 100865 -50335   100669 183.496 10  < 2.2e-16 ***
          # mod_ot5   25 100675 100870 -50312   100625  44.604  5  1.746e-08 ***
          # mod_ot6   31 100695 100937 -50317   100633   0.000  6    1.00000    
          # mod_ot7   39 100693 100997 -50308   100615  18.471  8    0.01796 *
