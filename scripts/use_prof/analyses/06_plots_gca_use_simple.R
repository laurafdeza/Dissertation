...
figs_path <- here("figs", "use_prof", "gca_simple")
...
ggsave(paste0(figs_path, "/plot_mon_simple.png"), plot_mon, width = 180,
...
ggsave(paste0(figs_path, "/en_gca_simple.png"), plot2, width = 180,
       height = 120, units = "mm", dpi = 600)
