...
Rhythm perception was actually positively associated with length of L2 experience  <font size="-1">(Bhatara et al., 2015)</font>. 
]
...
**H2.** _Pitch_     
No association between pitch and speech prediction abilities in L1 speakers and English learners. Mandarin speakers are expected to anticipate melodic information faster than any of the other populations. Performance in pitch anticipation will not be correlated with L2 anticipation performance. 
All auditory anticipation scores will be positively correlated with verbal WM scores in the L2 speakers <font size="-1">(Yang, 2017)</font>. WM is only expected to have an effect on non-linguistic auditory prediction abilities in non-Mandarin speakers <font size="-1">(Roden et al., 2014)</font>. 
...
include_graphics("./00_first_chapter/figs/tone_task.png", dpi = 130)
```
...
.center[
```{r, include=TRUE, echo=FALSE}
include_graphics("./00_first_chapter/figs/corsi.png", dpi = 140)
```
]
---
