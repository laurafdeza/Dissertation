...
There was a main effect of visuospatial prediction on the linear term (<em>&nbsp;chi^2^;</em>&nbsp;(1) =&nbsp;4.57, *p* = 0.033), indicating that the curve for those participants who tracked the trajectory more closely and pressed the button within the time window between when the car should have reappeared and when the press would have become a reaction pressed was steeper (see Figure 4), indicating they were increasing fixations on the target at a higher rate, therefore predicting language faster (`r report_row(5)`)
