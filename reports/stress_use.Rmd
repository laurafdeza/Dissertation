...
The lack of main effects from L1 (<em>&chi^2^;</em>&nbsp;(1) = 2.840, *p* = 0.092) and stress condition (<em>&chi^2^;</em>&nbsp;(1) = 0.570, *p* = 0.450) suggest that they were also anticipating preterit tense and that Mandarin speakers were also anticipating both tenses.
...
There were also interaction effects between proficiency x stress in the English speakers .
The negative value in this interaction suggests that present tense (paroxytone stress) was more difficult to anticipate than preterit tense, although higher proficiency helped in overcoming this difficulty (`r report_row('6')`).
...
Lastly, there were interaction effects for both L2 populations in the cubic term between proficiency x stress (<em>&chi^2^;</em>&nbsp;(2) = 6.657, *p* = 0.036).
The negative value in both cases indicates that the curve is more closed in the present tense than in the preterit tense (English: `r report_row('12')`; Mandarin: `r report_row('13')`).
...
There was an interaction effect of L2 use x stress in the linear term for the Mandarin speakers (<em>&chi^2^;</em>&nbsp;(2) = 11.632, *p* = 0.003).
The negative value of this effect indicates that the slope for the present tense predictions is steeper (`r report_row('11')`).
...
There was also an interaction effect in the cubic term for both L2 groups between L2 use x stress (<em>&chi^2^;</em>&nbsp;(2) = 6.967, *p* = 0.031).
The negative values in these interactions demonstrate that the curves for both L2 populations were more closed in the present tense than in the preterit tense, indicating they increased their fixations on present tense targets faster than in preterit tense targets (English: `r report_row('14')`; Mandarin: `r report_row('15')`).
...
While no L1 main effects were observed in the GCA models, the GLMMs to analyze the influence of predictors in more detail did show a different between L2 groups.
In the L2 use model, there were main effects of L1 (<em>&chi^2^;</em>&nbsp;(1) = 3.894, *p* = 0.048) and of L2 use (<em>&chi^2^;</em>&nbsp;(1) = 5.792, *p* = 0.016).
...
In the proficiency model, the main effect of L1 appeared before adding proficiency (<em>&chi^2^;</em>&nbsp;(1) = 3.894, *p* = 0.048) and the estimated difference between L1 groups remained when L2 proficiency was added <em>&gamma;</em>&nbsp;=&nbsp;-0.304, *SE* = 0.136, *z* = -2.238, *p* = .025.
There was also a main effect of proficiency (<em>&chi^2^;</em>&nbsp;(1) = 11.681, *p* = 0.001), such that higher proficiency correlated with increased anticipation (<em>&gamma;</em>&nbsp;=&nbsp;0.031, *SE* = 0.009, *z* = 3.496, *p* = .000).
